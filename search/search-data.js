/* ════════════════════════════════════════════════════════════════
   ...
   Modelo de um item:
   {
     ...
     conteudo: {
       ...
       imagens: ["public/img/foto.jpg", "public/img/2.jpg"],  // ou imagem: "..."
       videos: [
         "public/video/clip.mp4",                       // mp4 interno
         { youtube: "https://youtu.be/ID_DO_VIDEO" },   // YouTube
         { src: "public/video/x.mp4", poster: "cap.jpg" }
       ],
       audios: [ { src: "public/audio/faixa.mp3", titulo: "Nome da faixa" } ],
       botoes: [
...
window.SEARCH_DATA = [
  {
    ...
    to: "#312e81",
    conteudo: {
      imagens: ["public/img/foto-perfil.png"],
      markdown: `
...
`,
...

  {
    ...
    conteudo: {
      ...
      videos: [],
      imagens: [
        "public/artes/img1.jpg",
        "public/artes/img2.jpg",
        "public/artes/img3.jpg",
        "public/artes/img4.jpg",
        "public/artes/img5.jpg",
        "public/artes/img6.jpg",
        "public/artes/img7.jpg",
        "public/artes/img8.jpg",
        "public/artes/img9.jpg",
        "public/artes/img10.jpg",
        "public/artes/img11.jpg",
        "public/artes/img12.jpg",
      ],
      botoes: [
      ]
    }
...
`,
...

  {
    ...
    conteudo: {
      botoes: [
        { label: "Baixar currículo", url: "/public/pdf/curriculo.pdf", icone: "fa-solid fa-file-arrow-down", cor: "#7c3aed" },
